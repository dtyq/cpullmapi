...
GO_TEST_ARGS ?= -v
GO_ENV := CGO_ENABLED=1 GOCACHE=$(GO_CACHE_DIR) CGO_CFLAGS='$(LLAMACPP_CGO_CFLAGS)' C_INCLUDE_PATH=$(CRISPASR_INCLUDE_PATH) LIBRARY_PATH=$(CRISPASR_LIBRARY_PATH) CGO_LDFLAGS='$(GO_LDFLAGS)'
